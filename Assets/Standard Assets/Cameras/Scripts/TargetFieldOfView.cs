...
namespace UnityStandardAssets.Cameras
{
    public class TargetFieldOfView : AbstractTargetFollower
    {
        ...
        [SerializeField] private float m_ZoomAmountMultiplier = 5;      // a multiplier for the FOV amount. The default of 2 makes the field of view twice as wide as required to fit the target.
        ...
        {
            base.Start();
			m_BoundSize = 1;// MaxBoundsExtent(m_Target, m_IncludeEffectsInSize);
        ...
        protected override void FollowTarget(float deltaTime)
        {
			...
			requiredFOV = Mathf.Clamp (requiredFOV, 0, maxFOV); 
